    ...
    <>
      ...
      <section className="py-20 px-8" style={{ background: "var(--parchment)" }}>
        <div className="max-w-xl mx-auto text-center">
          ...
          >
            &ldquo;Each piece is designed to be discovered. From a distance, the work appears almost photographic &mdash; a pelican, a bee, a mosquito rendered with startling realism. Step closer and the illusion gives way to something more intimate: hundreds of tiny hand cut fragments of magazine paper, each one chosen for its color, texture, and tone. Stay a little longer, and the background beneath begins to speak &mdash; details and layers that only reveal themselves to those who take the time to look.&rdquo;
          </p>
